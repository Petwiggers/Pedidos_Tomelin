...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="Model/Produtos/<?= (empty($produto['id_produto'])) ? 'CadastroProduto.php' : 'EditarProduto.php' ?>" method="POST">
            <div class="mb-3">
            ...
            <div class="d-grid mt-4">
                ...
                <button type="submit" class="btn btn-primary btn-lg"><?= (empty($produto['id_produto'])) ? 'Cadastrar Produto' : 'Editar Produto' ?></button>
            </div>
